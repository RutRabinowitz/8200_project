...
print("sick_table.query_table(db.SelectionCriteria('ID', '>', '90'), db.SelectionCriteria('ID', '<', '10')])")
print(sick_table.query_table([db.SelectionCriteria("ID", '>', "90"),
                              db.SelectionCriteria("ID", '<', "10")]))

fight_corona_db.delete_table("Sick")
fight_corona_db.delete_table("Scientists")
fight_corona_db.delete_table("Sick_to_scientist")

os.remove("db_files/my_db.json")
